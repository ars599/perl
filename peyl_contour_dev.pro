...
ENDIF ELSE BEGIN
   map_set,/robinson,y_center,x_center,rotation,/NOBORDER,$ 
      POSITION=POSM,noerase=noerase,color=col_text,/HORIZON, /ISOTROPIC,limit=limits_loc;[-50,-180,50,180]
ENDELSE
endif
...
;         glinethick=axis_thick,horizon=horizon, latdel=latdel,londel=londel,label=0
         glinethick=axis_thick/2.,horizon=horizon, latdel=yaxis_interval,londel=xaxis_interval,label=0
      ENDIF ELSE BEGIN
...
;map_grid,color=col_text,horizon=horizon,lons=-180,latdel=0.,londel=0.,glinestyle=0,glinethick=axis_thick
;map_grid,color=col_text,horizon=horizon,lons=180,latdel=0.,londel=0.,glinestyle=0,glinethick=axis_thick
;map_grid,color=col_text,horizon=horizon,lats=-89.8,latdel=0.,londel=0.,glinestyle=0,glinethick=axis_thick
          map_grid,color=col_text,latdel=45.,londel=90.,glinestyle=1,glinethick=axis_thick/3.
      ENDELSE
  ENDIF
