...
; 
; PURPOSE: 
; Determines what range of a distribution lies within a percentile
; range. 
; 
; CATEGORY: 
; Math 
...
; 
; KEYWORD PARAMETERS: 
; CONFLIMIT: The fraction of the distribution encompassed. Default:
; 0.68 
; 
; OUTPUTS: 
; A 2-element vector of values that encompass a fraction CONFLIMIT 
; of the distribution. For example, if CONFLIMIT=0.68 then Result
; gives 
...
;- 
function percentiles2, values_, conflimit=conflimit

ii = where(finite(values_) eq 1,nn)
