...
;	z=CCG_STRRPOS('/home/gcarb/data/ch4/in-situ/brw_data/month/brw199512.ch4','/')
...
;
;		Example:
;			IDL> s='/home/gcarb/data/ch4/in-situ/mlo_data/month/mlo199512.ch4'
;			IDL> z=CCG_STRRPOS(s,'/')
