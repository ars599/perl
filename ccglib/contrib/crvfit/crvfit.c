...
char	*argv[];
{
	...
	*/
	...
	/*
	Determine values from smooth curve using predict file?
	*/
	if (strcmp(predfile,"")) {
		/*
		Get a value from
		...
		*/
		...
		spline_f(xfilt,ysc,&nfilt,xpred,curve,work,&npred);
		/*
		Write values from smooth curve to predict file.
		*/
		fp=fopen(predfile,"w");
		/*
		Flask smooth curve data.
