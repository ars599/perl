...
#define	GAUSSIAN	1
#define SYMMETRIC	0
#define ehg196 ehg196_
#define ehg169 ehg169_
#define lowesb lowesb_
#define lowese lowese_
#define lowesf lowesf_
#define lowesa lowesa_
#define lowesl lowesl_
#define lowesc lowesc_
#define lowesd lowesd_
