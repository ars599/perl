...
char	**argv;
{
	...
	*/	
	...
	strcpy(idl_loess.model.family,family);

	strcpy(idl_loess.control.surface,surface);
	strcpy(idl_loess.control.statistics,statistics);
	strcpy(idl_loess.control.trace_hat,trace_hat);
