...
;
; CALLING SEQUENCE:
;	CCG_FLASKAVE,sp='o18',site='asc',xret,yret,xnb,ynb,xrej,yrej
;	CCG_FLASKAVE,sp='co2',site='brw',xret,yret,xnb,ynb,xrej,yrej
;	CCG_FLASKAVE,sp='co2',file='test',nomessages=1,xret,yret,xnb,ynb,xrej,yrej
;
; INPUTS:
...
;		or
;
;			CCG_FLASKAVE,sp='co',file='/users/ken/test',xret,yret
;			PLOT, 	xret,yret,PSYM=6,COLOR=pen(2)
;		
...
IF NOT KEYWORD_SET(file) AND NOT KEYWORD_SET(site) THEN BEGIN
	...
	CCG_MESSAGE,"ex:  CCG_FLASKAVE, site='smo',sp='ch4'"
	RETURN
ENDIF
;
...
;
CCG_FSREAD2,file=file,sp=sp,header=header,nomessages=nomessages,nlines=nlines,x,y,flag
;
