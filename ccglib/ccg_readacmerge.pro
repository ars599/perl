...
;
;	FORMAT=A3,1X,I4,4(1X,I2),1X,A8,1X,A1,1X,F6.2,1X,F7.2,1X,I7,1X,A2,1X,F6.1,1X,F6.1,1X,F6.1,
;		<#>(1X,F8.3,1X,A3)
;
...
;	CCG_READACMERGE,file='/home/gcarb/data/aircraft/car/history/1999/1999-07-07.1641.mrg',a
;
; INPUTS:
...
;		Example:
;			CCG_READACMERGE,$
;			file='/home/gcarb/data/aircraft/car/history/1999/1999-07-07.1641.mrg',$
;			arr
;			.
;			.
;			.
...
sformat1='(A3,1X,I4,4(1X,I2),1X,A8,1X,A1,1X,F6.2,1X,F7.2,1X,I7,1X,A2,1X,F6.1,1X,F6.1,1X,F6.1)'
sformat2='(1X,F8.3,1X,A3)'

yr=0  & mo=0  & dy=0  & hr=0  & mn=0
st='' & fi='' & me='' & fl='' & in=''
lat=0. & long=0. & alt=0L & altflg=''
te=0. & pr=0. & rh=0.
