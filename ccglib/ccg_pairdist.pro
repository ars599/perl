...
if not keyword_set(file) then file = '/home/gcarb/data/' + dir + '/flask/site/' + site + '.' + species
...
ccg_pairdiff, sp=species, file=temp, cond=cond, diff=diff, gp=gp
spawn, 'rm ' + temp
