...
;
;========================================================================
FUNCTION PEYL_TRANSPORT, obs_name, obs_start, obs_end, $
                         flux, flux_date, $
...
FORWARD_FUNCTION time_extrapolate

journal,'journal_peyl_transport.txt'
...
case strlowcase(type_simul) of 
    'month_lmdz96' : begin
        path_retro = ['/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZ96/BACKRUN/',$
                      '/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZ96/BACKRUN2/'] 
        site_info = ['/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZ96/sites_backrun',$
                    '/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZ96/sites_backrun2']
        prefix = ['backrun.lmdz96.histrac.','backrun2.lmdz96.histrac.']
        obs_units = 'months'
        grid_name = 'lmdz96'
        coef_retro = 1.0e20     
    end
                                ;--- transport for one year only 2001
    'month_lmdze192' : begin
        path_retro = ['/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZE192/'] 
        site_info = ['/home/inversion/LMDZ/RETROS/RETROS_MENS/LMDZ96/sites_backrun']
        ...
        coef_retro = 1.0e20     
                                ...
                                ;--- transport for 3 months only and
                                ;    for 2001 and 10 stations.. pour Europe
    'day_lmdze192' : begin
        ...
        coef_retro = 1.0e20     
                                ...
                                ;--- transport for 3 months only and
                                ;    for 2005 and 5 stations.. pour siberie
    'day_lmdz_euras' : begin
        path_retro = ['/home/atmosphere/carouge/RETRO_JOUR/LMDZ_EURAS/']                      
        site_info = ['??']
        prefix = 'retro.histrac.'
        obs_units = 'days'
        grid_name = 'lmdz_euras'
        coef_retro = 1.0e20     
    end
    else : begin
