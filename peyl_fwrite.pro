...
;
; CALLING SEQUENCE:
;	PEYL_FWRITE,file=filename,nc=1,x
;	PEYL_FWRITE,file='/users/ken/temp',nc=4,a,b,c,d
;	PEYL_FWRITE,file='temp',nc=3,var(0,*),var(1,*),var(2,*)
;
; INPUTS:
...
;
;	Example:
;		PEYL_FREAD,file='testfile',nc=5,var
;		.
;		.
;		.
;		PLOT, var(0,*),var(1,*)
...
;		.
;		.
;		PEYL_FWRITE,file='temp',nc=2,var(3,*),var(4,*)
;		.
;		.
;		.
;		
...
IF NOT KEYWORD_SET(file) OR NOT KEYWORD_SET(nc) THEN BEGIN
	...
	CCG_MESSAGE,"(EX) PEYL_FWRITE,file='/users/ken/temp',nc=3,x,y,z"
	RETURN
ENDIF
;
...
if header ne '' then printf,unit,header
