...
;============================================================================
FUNCTION peyl_choixoce, selection, grid_name=grid_name
@map2d_com
...
path='/home/gcarb/contrib/chgrid/MASK/'
...
bb=see_mask 
dd0 = 0 
if grid.lat(plat(0)) gt lat(0) then dd0 = 1
...
bb=see_mask
dd1=0
if grid.lat(plat(1)) gt lat(1) then dd1 = 1

bb(0:plon(1),plat(0)+1-dd0:plat(1)-dd1) = 999
bb(plon(7)+1:*,plat(0)+1-dd0:plat(1)-dd1) = 999
bb(ii_land) = 0
...
bb(plon(1)+1:plon(2),plat(0)+1-dd0:plat(1)-dd1) = 999
bb(ii_land) = 0
...
bb(plon(2)+1:plon(4),plat(0)+1-dd0:plat(1)-dd1) = 999
bb(ii_land) = 0
...
bb(plon(4)+1:plon(7),plat(0)+1-dd0:plat(1)-dd1) = 999
bb(ii_land) = 0
...
bb=see_mask 
dd2=0
if grid.lat(plat(2)) gt lat(2) then dd2 = 1

bb(0:plon(1),plat(1)+1-dd1:plat(2)-dd2) = 999
bb(ii_land) = 0
...
bb(plon(6)+1:*,plat(1)+1-dd1:plat(2)-dd2) = 999
bb(ii_land) = 0
...
bb(plon(1)+1:plon(2),plat(1)+1-dd1:plat(2)-dd2) = 999
bb(ii_land) = 0
...
bb=see_mask 
dd3=0
if grid.lat(plat(3)) gt lat(3) then dd3 = 1

bb(plon(2)+1:plon(6),plat(1)+1-dd1:plat(2)-dd2) = 999
bb(plon(3)+1:plon(5),plat(2)+1-dd1:plat(3)-dd3) = 999
bb(ii_land) = 0
...
bb(0:plon(0),plat(2)+1-dd2:plat(3)-dd3) = 999
bb(plon(5)+1:*,plat(2)+1-dd2:plat(3)-dd3) = 999
bb(ii_land) = 0
...
bb=see_mask 
dd5 = 0 
if grid.lat(plat(5)) gt lat(5) then dd5 = 1

bb(0:plon(0),plat(3)+1-dd3:plat(5)-dd5) = 999
bb(plon(5)+1:*,plat(3)+1-dd3:plat(5)-dd5) = 999
bb(ii_land) = 0
...
bb=see_mask 
dd4 = 0 
if grid.lat(plat(4)) gt lat(4) then dd4 = 1

bb(plon(0)+1:plon(3),plat(2)+1-dd2:plat(4)-dd4) = 999
bb(plon(0)+1:plon(5),plat(2)+1-dd2:plat(4)-dd4) = 999
bb(ii_land) = 0
...
bb=see_mask 
bb(plon(0)+1:plon(3),plat(4)+1-dd4:*) = 999
bb(ii_land) = 0
...
bb=see_mask 
bb(0:plon(0),plat(5)+1-dd5:*) = 999
bb(plon(3)+1:*,plat(5)+1-dd5:*) = 999
bb(ii_land) = 0
...
if 0 then begin
   ...
   data=see_mask
   data(*)=0
   data(ii_aus)=1 & k=k+n_elements(ii_aus)
